...
def call_gemini_llm(biomechanics: Dict[str, Any],
    ...
    # Use the GEMINI_API_KEY constant defined at the top of the file
    ...
    if api_key and annotated_video_path:
        try:
            ...
            # Pass through the response with validation for required fields
            analysis = {
    ...
    analysis = {
        ...
        "strengths": [
            ...
            f"Strong balance with {biomechanics['balance_score']}% stability score",
            f"Racket head speed averaging {biomechanics['racket_head_speed']:.1f} MPH"
        ],
        "fixes": [
